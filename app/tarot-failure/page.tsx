...
export default function TarotFailurePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/20 to-slate-900 flex items-center justify-center p-4">
      ...
      <div className="bg-slate-800/80 border-red-400/30 backdrop-blur-sm rounded-lg shadow-lg p-8 max-w-md w-full text-center relative z-10">
        <div className="mb-6">
          ...
          <p className="text-red-300">
            No se pudo procesar tu pago. Por favor, intentá de nuevo.
          </p>
        </div>
        ...
        <div className="mt-6 text-center text-xs text-violet-400">
          <p>¿Tenés problemas con el pago? Contactanos:</p>
