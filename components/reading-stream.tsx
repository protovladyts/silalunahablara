...
function ReadingStreamContent({ reading, loopsUsed, maxLoops = 3, cards = [], onReask, onFinish, onVideoCallOffer, onUpsell }: ReadingStreamProps) {
  ...
  const canReask = messages.canReask
          ...
          >
            <Card className="bg-slate-800/80 border-violet-400/30 backdrop-blur-sm">
              <CardHeader className="text-center">
                <CardTitle className="text-xl text-violet-100">Tus cartas del tarot</CardTitle>
                <CardTitle className="text-sm text-violet-300">
                  Las cartas que has elegido para esta lectura
                </CardTitle>
              </CardHeader>
